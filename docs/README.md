...
SCA 与 SAST 治理前端也已改为任务型五工作区：SCA 使用“概览、风险组件、依赖影响、例外与 VEX、历史与报告”，SAST 使用“概览、代码风险、AI 辅助复核、扫描策略、例外与报告”。默认首屏不再平铺历史、规则、CI、Worker 和报告等管理能力；它们按用户任务进入对应工作区。Semgrep 明确归属 SAST，并作为补充本地规则覆盖面的增强引擎在扫描策略首项直接可见；SCA 不展示 Semgrep。
