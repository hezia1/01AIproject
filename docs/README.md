...
本目录承接 `artifacts/audit-ppt-20260809/01.pptx` 的目标，并记录仓库截至 **2026-08-29** 的实际实现。根目录 [`README.md`](../README.md) 是启动、使用和安全边界的主入口；出现冲突时，以代码、数据库迁移、自动化测试和根 README 的当前说明为准。
