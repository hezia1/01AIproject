...
5. [`PROJECT_HANDOFF_2026-07-26.md`](PROJECT_HANDOFF_2026-07-26.md)：当前交接快照；文件名因外部引用而保留。
6. 专题文档：[`SAST_CI_INTEGRATIONS.md`](SAST_CI_INTEGRATIONS.md)、[`sca-ci-gate.md`](sca-ci-gate.md)、[`sandbox-adapter-protocol.md`](sandbox-adapter-protocol.md)。
