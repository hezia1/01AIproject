...
MODULE_REGISTRY: dict[ModuleKey, SecurityModule] = {
    ...
    ModuleKey.dast: SecurityModule(
        ...
        code="DAST",
        name="漏洞动态验证",
        subtitle="受控 Web 基础观察 + 风险关联建议 + 人工三态裁决",
        category=ModuleCategory.validation,
        description="对已确认的项目运行地址执行一次无认证 Web 基础观察，并将人工验证记录关联至上游风险；自动观察不构成漏洞可利用性裁决。",
        capabilities=[
            ModuleCapability(title="Web 基础观察", description="仅对已确认的同源项目目标发送一次无认证 GET。"),
            ModuleCapability(title="风险关联建议", description="按 URL 与风险元数据提供需人工确认的关联建议。"),
            ModuleCapability(title="人工三态裁决", description="人工验证可记录可利用、不确定或限定范围内未复现。"),
            ModuleCapability(title="结构化观察摘要", description="保存状态、耗时与响应头摘要，不保存截图或原始响应正文。"),
        ],
