...
class SecuritySkillRecord(Base):
    ...
    auto_trigger_scan_types: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
...
class SecuritySkillRunRecord(Base):
    ...
    trigger_scan_task_id: Mapped[str | None] = mapped_column(UUID(as_uuid=False), ForeignKey("scan_tasks.id"))
