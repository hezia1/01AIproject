...
function GovernanceCenter({
  ...
  return <section className="governance-center">
    ...
    {scope === "sast" ? <><SastOperationsConsole project={project} /><SastRuleReleaseConsole project={project} /><SastSemanticDelivery project={project} /><SastFixDrafts project={project} /><SastRuleManagement project={project} /><SastEvidenceGovernance project={project} /><FindingModuleGovernance moduleKey="sast" findings={findings.filter((item) => item.source === "SAST")} validations={validations} evidence={evidence} graph={graph} comparison={retestComparisons.sast} loading={scopeLoading("sast")} onRunReview={onRunSastAgentReview} onRun={() => onRunModule("sast")} onUpdateFinding={onUpdateFinding} /></> : null}
