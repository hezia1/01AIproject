...
type ScaToolStatus = { enabled: boolean; status: string; syft_component_count: number; grype_vulnerability_count: number; trivy_vulnerability_count?: number; grype_input?: string | null; syft_status?: string; syft_detail?: string | null; grype_status?: string; grype_detail?: string | null; trivy_status?: string; trivy_detail?: string | null; dependency_resolution_status?: string; dependency_resolution_detail?: string | null; errors: string[] };
